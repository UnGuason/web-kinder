...
infante:Persona;
  ...
  constructor(private servicioBD:BaseDatosService,private router:Router) {
...
if(!this.segundoPAdre){
  console.log('envia uno solo')
  
  this.servicioBD.SendUsuario( this.padre1,null,this.infante,"asdassd").subscribe(data=>{
